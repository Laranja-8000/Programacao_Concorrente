...
class LE {
  ...
  public synchronized void EntraEscritor (int id) {
      // # Alteração: o escritor não pede permissão pra entrar:
      this.escr++; 
...
class LeitorEscritor {
  ...
  static final int E = 1; // Inicialmente fazendo o teste com 1 thread escritora pra observar mais fácil o comportamento de bloqueio e desbloqueio
  ...
  public static void main (String[] args) {
    ...
    System.out.println ("import verificaLEnovo");
    System.out.println ("le = verificaLEnovo.LE()");
