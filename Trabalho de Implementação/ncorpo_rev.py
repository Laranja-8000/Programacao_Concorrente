...
offset = 15.0
par.append(Particle(initial_pos = Vec2(0+offset,0+offset), initial_vel = Vec2(0.0,0.0) , mass = 15.))
par.append(Particle(initial_pos = Vec2(0.+offset,5.0+offset), initial_vel = Vec2(1.2,0) , mass = 1.))
par.append(Particle(initial_pos = Vec2(offset+0.0,offset+7.5), initial_vel = Vec2(1.,0) , mass = 1.))
#par.append(Particle(initial_pos = Vec2(offset+0,offset-5.0), initial_vel = Vec2(-1.2,0.0) , mass = 1.))
#par.append(Particle(initial_pos = Vec2(offset+0,offset+5.0), initial_vel = Vec2(1.2,0.0) , mass = 1.))


# Simulation time and number of steps
t_end = 120.0
steps = int(t_end)*60*2
...
# run the animation
ani = FuncAnimation(fig, animate, frames=120, interval=32, repeat=True)
